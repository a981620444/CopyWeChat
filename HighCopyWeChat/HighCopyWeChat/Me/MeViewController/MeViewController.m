...
- (void)viewDidLoad {
    [super viewDidLoad];
    dataArray = @[@[@{@"headImg":@"avatar.jpg",@"name":@"Topsky",@"number":@"微信号：123456789"}],
    ...
    UITableView *meTab = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-49-64) style:UITableViewStylePlain];
