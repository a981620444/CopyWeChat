...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"朋友圈";
    CircleHeadView *headV = [[CircleHeadView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 280)];
    self.circleTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64) style:UITableViewStyleGrouped];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    UIView *view2 = [[UIView alloc]initWithFrame:CGRectMake(0, 7.7, SCREEN_WIDTH, 0.3)];
...
- (void)didClickLikeButton:(NSInteger)section {
    ...
    for (NSDictionary *likerDic in item.like_users) {
        if ([likerDic[@"userName"] isEqualToString:@"Topsky"]) {
            isContain = YES;
            containDic = likerDic;
            break;
        }
    ...
    if (isContain) {
        ...
        [likerArray addObject:@{@"userId": @"0", @"userName": @"Topsky"}];
    }
...
-(void)setTextViewFrame{
    self.textBackView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 49)];
...
-(void)keyboardWillShow :(NSNotification *)notification{
    ...
    [UIView animateWithDuration:duration animations:^{
        self.closeKeyboardYbgView.frame = CGRectMake(0, 0, SCREEN_WIDTH, endKeyboardY - 49);
        self.textBackView.frame = CGRectMake(0, endKeyboardY - 64 - 49, SCREEN_WIDTH, 49);
        self.circleTable.frame = CGRectMake(0, 0, SCREEN_WIDTH, endKeyboardY - 64 - 49);
    }];
...
-(void)keyboardWillhide :(NSNotification *)notification{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.textBackView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 49);
        self.circleTable.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64);
    }];
