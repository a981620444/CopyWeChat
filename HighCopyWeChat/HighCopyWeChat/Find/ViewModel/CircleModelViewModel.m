...
-(CGFloat)CalculateContentHeight:(NSString *)string{
    ...
    CGSize attSize = [str boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - 60, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading context:nil].size;
...
-(CGFloat)getLikerCellRowHeight:(CircleModel *)item{
    ...
    CGFloat heighht = [attributeLiker boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - 70, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading context:nil].size.height;
...
-(NSMutableArray *)getCommentsCellRowHeight:(CircleModel *)item{
    ...
    for (NSDictionary *commentsDic in item.comments) {
        ...
        CGFloat commentsHeight = [attString boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - 70, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading context:nil].size.height;
